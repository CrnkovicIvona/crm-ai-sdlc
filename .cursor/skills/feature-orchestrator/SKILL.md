...
| `IN_QA`             | Wait; CI heal if needed. Optional `exploratory-qa-expert` (charter session + EXP debrief; not a checklist pass); do not self-approve QA                                                    | Self-approve QA gate                                                      |
