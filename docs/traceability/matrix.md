...
| CRM-001 (no Issue yet)                                               | REQ-CRM-001             | FR-C001–FR-C013                | US-C001–US-C006 | AC-C001–AC-C019        | [features/CRM-001/bdd.md](../features/CRM-001/bdd.md) | TC-C001–TC-C019        | TDE-C001–TDE-C008; [TS](../features/CRM-001/technical-spec.md)           | `src/pages/ClientListPage.tsx`, `ClientFormPage.tsx`, `ClientDetailPage.tsx`, `src/lib/clients.ts`, `supabase/migrations/20260823190000_clients_and_audit.sql`, `tests/e2e/clients.spec.ts`, `tests/integration/clients-rls.test.ts` | High |
