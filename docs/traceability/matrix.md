...
- AUTH-001 DoR on Issue #5. CRM-001 Gate 1/2 in chat 2026-08-23; no
  GitHub Issue.
- DASH-001 is **`ON_MAIN`** (REL-006 on `main`; REL-007 prepared from
  `test` `ad191ad`). Not `RELEASED`. Production smoke **NOT EXECUTED**.
  Non-prod: [test-reports/DASH-001.md](../test-reports/DASH-001.md)
  (`test` CI run 34856651861; REL-007 run 35468058847).
...
[REL-006](../releases/REL-006.md) (DASH-001; **ON_MAIN** after merge;
smoke **NOT EXECUTED**),
[REL-007](../releases/REL-007.md) (BUG-004 + AUTH-B001; **ON_MAIN**
after merge; smoke **NOT EXECUTED**).
