...
| DASH-001 (no Issue yet)                                              | REQ-DASH-001            | FR-D001–FR-D015                | US-D001–US-D004 | AC-D001–AC-D013, AC-D015 | [features/DASH-001/bdd.md](../features/DASH-001/bdd.md) | TC-D001–TC-D015        | TDE-D001–TDE-D005; [TS](../features/DASH-001/technical-spec.md)          | `src/lib/dashboardMetrics.ts`, `src/lib/dashboard.ts`, `src/pages/DashboardPage.tsx`, `src/App.tsx`, `src/pages/AppShell.tsx`, `src/index.css`, `supabase/migrations/20260919193000_client_lifecycle_stamps.sql`, `tests/unit/dashboardMetrics.test.ts`, `tests/unit/clientLifecycleStamps.tc-d015.test.ts`, `tests/integration/dashboard-stamps.test.ts`, `tests/e2e/dashboard.spec.ts`, `tests/smoke/rel-007.spec.ts` (`RELEASED`; REL-007 smoke 14/14) | High |

Functional specification: [FS-AUTH-001](../specifications/functional/AUTH-001.md).
CRM-001 pack: [../features/CRM-001/](../features/CRM-001/).
DASH-001 pack: [../features/DASH-001/](../features/DASH-001/)
(`RELEASED`; REL-007 smoke 14/14 PASS, run 35469423656).
...
- AUTH-001 DoR on Issue #5. CRM-001 Gate 1/2 in chat 2026-08-23; no
  GitHub Issue.
- DASH-001 is **`RELEASED`** (REL-006 product; REL-007 PR #56
  `bee44a9`). Production smoke **PASSED** 14/14
  [run 35469423656](https://github.com/CrnkovicIvona/crm-ai-sdlc/actions/runs/35469423656)
  (`https://crm-ai-sdlc.vercel.app`). Non-prod:
  [test-reports/DASH-001.md](../test-reports/DASH-001.md)
  (`test` CI run 34856651861; REL-007 run 35468058847). Hosted
  `TC-D015-ui` SKIPPED ≠ PASSED.
...
[REL-006](../releases/REL-006.md) (DASH-001 product on `main`),
[REL-007](../releases/REL-007.md) (BUG-004 + AUTH-B001; **RELEASED**;
smoke 14/14 PASS, run 35469423656).
