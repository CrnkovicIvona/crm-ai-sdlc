...
| AUTH-001 [#5](https://github.com/CrnkovicIvona/crm-ai-sdlc/issues/5) | REQ-001, BD-008         | FR-013                         | US-002          | AC-012                 | [bdd/AUTH-001.md](../bdd/AUTH-001.md)                 | TC-010                 | TDE-001, TD-008; [TS](../specifications/technical/AUTH-001.md)           | `src/lib/access.ts`, `src/pages/AccessDeniedPage.tsx`, `tests/e2e/auth.spec.ts` | High |
...
Playwright candidates TC-001–TC-010 are test architecture (TDE-008),
