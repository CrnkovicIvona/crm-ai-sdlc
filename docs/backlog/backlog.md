...
| ---------------------------------------------------------- | ------------------------------ | --------- | -------- | -------- | ----- | ------------ |
| [AUTH-B001](tasks/AUTH-B001-login-test-user-spacing.md)    | Login test-user blocks spacing | Auth      | Proposed | Low      | TBD   | 2026-09-19   |
...
dashboard_backlog:
  - id: DASH-B001
    ...
    area: Dashboard
    description: VIEWER Last 30 New=620 Churned=0; ADMIN New=815 Churned=195. Investigate RLS, queries, column access. See BUG-004.
    priority: high
    status: open
  ...
  - id: DASH-B002
    ...
    area: Dashboard
    description: Verify SELECT columns and filters. VIEWER may not receive deleted_at or created_at for churn/new.
    priority: high
    status: open
  - id: DASH-B003
