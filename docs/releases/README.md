...
| [REL-006](REL-006.md) | DASH-001 dashboard + BUG-002/BUG-003 chrome               | Product on `main`; DASH **`RELEASED`** after REL-007 smoke 14/14 |
| [REL-007](REL-007.md) | BUG-004 stamps + AUTH-B001 login spacing                  | **RELEASED** (PR #56 + smoke 14/14 PASS, run 35469423656)        |
