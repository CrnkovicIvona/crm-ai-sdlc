...
| [REL-004](REL-004.md) | CRM-001 clients, products, soft-delete                    | **ON_MAIN — not RELEASED** (smoke not executed)               |
| [REL-005](REL-005.md) | Promote `test` (apply-schema, README, CRM test isolation) | **not merged** — after merge still ON_MAIN until smoke PASSED |
