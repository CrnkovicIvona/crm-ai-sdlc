...
- Lifecycle: **AUTH-001 remains `RELEASED`**. **CRM-001 is `RELEASED`**
  after REL-005 production smoke **PASSED** 2026-09-13
...
testing-strategy CRM implemented; CRM-001 later **`RELEASED`**;
