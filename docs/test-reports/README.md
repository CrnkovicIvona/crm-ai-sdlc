...
- [CRM-001](CRM-001.md) — SHA `456c9a2`: e2e 11/11; Vitest 19/19 including RLS
- [QA-CLOSEOUT-001](QA-CLOSEOUT-001.md) — Phase 6; automated DoD High met; human QA / RELEASED not claimed
