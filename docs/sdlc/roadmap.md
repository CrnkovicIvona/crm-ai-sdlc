...
| DASH-001 | Dashboard after Clients exist                            | [../features/DASH-001/](../features/DASH-001/)    | **`SPECIFIED`** (docs pack; not implemented; not `RELEASED`)          |
...
3. **DASH-001** — **`SPECIFIED`**. Pack:
   [../features/DASH-001/](../features/DASH-001/). Human DoR 2026-09-13.
   **Not** `IN_DEVELOPMENT` until `src/` is approved. **Not**
   `RELEASED`. Do not implement until
   [implementation-plan.md](../features/DASH-001/implementation-plan.md)
   is Approved and the human asks to code.
