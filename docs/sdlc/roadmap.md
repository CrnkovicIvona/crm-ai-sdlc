...
| -------- | ----------------------------------------- | ------------------------------------------------- | ------------------------------------------- |
| AUTH-001 | Login, roles, logout, fail-closed access  | `docs/requirements/REQ-001.md` and AUTH-001 specs | `SPECIFIED` until a **human** records Ready |
...
1. **AUTH-001** — paths stay under `docs/requirements/` and related
   AUTH-001 files. Do not migrate these into `docs/features/` without
   an explicit docs task.
