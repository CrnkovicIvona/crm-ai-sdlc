...
| REQ-DASH-001 | FR-D015 | US-D002 | AC-D015 | AC-D015 | TC-D015         | TDE-D005 | `supabase/migrations/20260919193000_client_lifecycle_stamps.sql`, `src/lib/dashboard.ts`, `tests/integration/dashboard-stamps.test.ts` | NOT EXECUTED until CI/live DB has the view |
