...
| REQ-CRM-001 | FR-C003 | US-C002 | AC-C003 | ADMIN can read Clients               | TC-C003 | TDE-C002, TDE-C003 | see matrix.md  | AUTOMATED e2e — must execute when `E2E_*` set (skip only if secrets missing)                 |
| REQ-CRM-001 | FR-C003 | US-C002 | AC-C004 | ADMIN can create a Client            | TC-C004 | TDE-C002, TDE-C003 | see matrix.md  | AUTOMATED e2e — missing catalog is FAIL, not skip                                            |
| REQ-CRM-001 | FR-C003 | US-C002 | AC-C005 | ADMIN can update a Client            | TC-C005 | TDE-C002, TDE-C003 | see matrix.md  | AUTOMATED e2e — must execute when `E2E_*` set                                                |
| REQ-CRM-001 | FR-C003 | US-C002 | AC-C006 | ADMIN can delete a Client            | TC-C006 | TDE-C002, TDE-C003 | see matrix.md  | AUTOMATED e2e — must execute when `E2E_*` set                                                |
