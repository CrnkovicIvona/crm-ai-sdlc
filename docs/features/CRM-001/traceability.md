...
| REQ-CRM-001 | FR-C002 | US-C001 | AC-C002 | Client has the approved fields       | TC-C002 | TDE-C001           | see matrix.md  | AUTOMATED e2e (partial field errors) + `tests/unit/clientValidation.test.ts` — NOT EXECUTED  |
