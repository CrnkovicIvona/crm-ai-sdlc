...
- State: **`PLANNED`** (Gate 2 PO chat 2026-08-23). Implementation is
  in review for Gate 3 (`test`). **Not on `main`.** **Not `RELEASED`.**
...
| Implementation plan | [implementation-plan.md](implementation-plan.md) (**Approved** / `PLANNED`) |
